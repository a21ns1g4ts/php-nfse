...
class Tools extends ToolsAbrasf
{
     ...
     * @var array
     */
    protected $namespaces = ['xmlns:soapenv' => "http://schemas.xmlsoap.org/soap/envelope/", 'xmlns:nfe' => "http://nfe.mogimirim.sp.gov.br"];
    ...
    {
        $class = "NFePHP\\NFSe\\Counties\\M3530805\\v{$this->versao}\\RecepcionarLoteRps";
    ...
    {
        $class = "NFePHP\\NFSe\\Counties\\M3530805\\v{$this->versao}\\ConsultarLoteRps";
        $fact = new $class($this->certificate);
    ...
    {
        $class = "NFePHP\\NFSe\\Counties\\M3530805\\v{$this->versao}\ConsultarSituacaoLoteRps";
        $fact = new $class($this->certificate);
    ...
    {
        $class = "NFePHP\\NFSe\\Counties\\M3530805\\v{$this->versao}\\ConsultarNfsePorRps";
        $fact = new $class($this->certificate);
    ...
    protected function sendRequest($url, $message)
    {
        ...
        if (!is_object($this->soap)) {
            $this->soap = new \NFePHP\NFSe\Counties\M3530805\SoapCurl($this->certificate);
        }
    ...
    public function cancelarNfse($nfseNumero)
    {
        ...
        $class = "NFePHP\\NFSe\\Counties\\M3530805\\v{$this->versao}\\CancelarNfse";
        $fact = new $class($this->certificate);
